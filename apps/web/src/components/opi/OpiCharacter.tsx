...
/**
 * Opi v2 — the orange cube robot mascot (inline SVG, no assets).
    ...
    >
      <defs>
        <linearGradient id="opiBody" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="1" stopColor="#f07000" />
        </linearGradient>
        <radialGradient id="opiOrb" cx="0.35" cy="0.35" r="1">
          <stop offset="0" stopColor="#ffd9a8" />
          <stop offset="0.5" stopColor="#ff9d2e" />
      ...
      <g className={styles.sway}>
        ...
        <g className={thinking ? styles.footTap : undefined}>
          ...
          <rect x="46" y="130" width="21" height="8" rx="4" fill="#f07000" />
        </g>
        <rect x="77" y="120" width="13" height="14" rx="5" fill="url(#opiBody)" />
        <rect x="73" y="130" width="21" height="8" rx="4" fill="#f07000" />
        ...
        <g className={happy ? styles.armHappyL : undefined}>
          ...
          <circle cx="31.5" cy="116" r="7" fill="#ffb14d" />
        </g>
        <g className={waving ? styles.waveArm : happy ? styles.armHappyR : undefined}>
          ...
          <circle cx="108.5" cy="116" r="7" fill="#ffb14d" />
        </g>
        ...
        <g className={thinking ? styles.eqFast : undefined}>
          <rect className={styles.eq1} x="60" y="94" width="4" height="12" rx="2" fill="#ff8a00" />
          <rect className={styles.eq2} x="68" y="94" width="4" height="12" rx="2" fill="#ffb14d" />
          <rect className={styles.eq3} x="76" y="94" width="4" height="12" rx="2" fill="#ff8a00" />
        </g>
        ...
        <g ref={headRef} className={styles.head}>
          ...
          <circle className={styles.orbHalo} cx="70" cy="9" r="9" fill="#ff8a00" />
          <circle className={thinking ? styles.orbThinking : styles.orb} cx="70" cy="9" r="5.5" fill="url(#opiOrb)" />

          {/* ear pods */}
          <rect x="24" y="42" width="8" height="18" rx="4" fill="#f07000" />
          <rect x="108" y="42" width="8" height="18" rx="4" fill="#f07000" />
          ...
          <rect className={styles.scanline} x="42" y="38" width="56" height="3" rx="1.5" fill="#ff8a00" />

          {/* eyes — gaze group is translated imperatively */}
          <g ref={pupilsRef} transform={thinking ? 'translate(0 -2)' : undefined}>
            {sleeping ? (
              <>
                <path d="M52 52 q5 3 10 0" stroke="#ff8a00" strokeWidth="2.4" strokeLinecap="round" fill="none" />
                <path d="M78 52 q5 3 10 0" stroke="#ff8a00" strokeWidth="2.4" strokeLinecap="round" fill="none" />
              </>
            ) : happy ? (
              <>
                <path d="M52 53 q5 -8 10 0" stroke="#ffb14d" strokeWidth="3" strokeLinecap="round" fill="none" />
                <path d="M78 53 q5 -8 10 0" stroke="#ffb14d" strokeWidth="3" strokeLinecap="round" fill="none" />
              </>
            ) : (
              <>
                <rect className={styles.eye} x="53" y="45" width="8" height="15" rx="4" fill="#ff8a00" />
                <rect className={styles.eye} x="79" y="45" width="8" height="15" rx="4" fill="#ff8a00" />
              </>
            )}
          </g>
          ...
          {happy ? (
            <>
              <ellipse cx="48" cy="61" rx="4.5" ry="2.6" fill="#ff8a00" opacity="0.35" />
              <ellipse cx="92" cy="61" rx="4.5" ry="2.6" fill="#ff8a00" opacity="0.35" />
            </>
          ) : null}

          {/* mouth per mood */}
          {thinking ? (
            <circle cx="70" cy="64" r="2.8" fill="none" stroke="#ff8a00" strokeWidth="2" />
          ) : happy ? (
            <path d="M62 61 q8 9 16 0 z" fill="#ff8a00" opacity="0.9" />
          ) : sleeping ? (
            <path d="M64 64 q6 3 12 0" stroke="#ff8a00" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.7" />
          ) : (
            <path d="M61 62 Q70 69 79 62" fill="none" stroke="#ff8a00" strokeWidth="2.6" strokeLinecap="round" />
          )}
        </g>

        {/* Zzz while sleeping */}
        {sleeping ? (
          <g fill="#ffb14d" fontFamily="monospace" fontWeight="bold">
