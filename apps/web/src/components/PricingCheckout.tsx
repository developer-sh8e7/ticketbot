...
function ProductRow({
  ...
  const rowClassName = `flex min-h-[72px] w-full items-center justify-between gap-4 border-b border-[var(--color-border)] border-l-[3px] px-4 py-3 text-start transition last:border-b-0 ${
    selected
      ? 'border-l-[var(--color-accent)] bg-[rgba(15,201,143,0.07)]'
    ...
    <div dir="rtl" className="grid gap-8">
      <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <button
            ...
            className={`rounded-2xl border px-4 py-3 text-center font-arabic transition ${
              billingPeriod === 'monthly'
                ? 'border-[var(--color-accent)] bg-[var(--color-accent)] text-black shadow-[0_0_28px_rgba(15,201,143,0.22)]'
          ...
          >
            <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[var(--color-accent-2)] px-3 py-1 text-[11px] font-extrabold text-[var(--color-bg)] shadow-[0_0_18px_rgba(15,201,143,0.22)]">
              وفّر 5%
            </span>
