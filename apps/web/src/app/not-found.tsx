...
export default function NotFoundPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <Link href="/" className="rounded-xl border border-opus-border bg-opus-accent px-5 py-2.5 text-sm font-semibold text-white hover:bg-opus-accent/90">العودة للرئيسية</Link>
    </div>
  );
}
