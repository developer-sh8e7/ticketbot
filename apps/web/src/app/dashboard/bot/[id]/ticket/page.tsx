...
const quickCards = [
  { icon: ImageIcon, title: 'صورة البنل', text: 'غيّر صورة البنل برابط مباشر مع معاينة فورية.' },
  { icon: LayoutList, title: 'تصنيفات البنل', text: 'أضف وعدّل خيارات قائمة فتح التذاكر.' },
  { icon: MousePointerClick, title: 'أزرار التذكرة', text: 'نص ولون أزرار الإغلاق والاستلام وغيرها.' },
  { icon: Ticket, title: 'الرومات والرتب', text: 'روم البنل واللوق وكاتقوري التذاكر ورتبة الدعم.' },
];
      ...
      <section className="overflow-hidden rounded-3xl border border-opus-border bg-[radial-gradient(circle_at_top_right,rgba(221,255,0,0.12),transparent_35%),var(--color-surface)] p-5 sm:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl font-arabic text-sm leading-7 text-opus-muted">تحكّم في شكل البنل، صورته، أزراره، والرومات — كل التغييرات تنعكس على البوت تلقائياً.</p>
          </div>
