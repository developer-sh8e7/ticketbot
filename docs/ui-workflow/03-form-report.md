...
- لوحة التفاصيل absolute اعلى اليسار على سطح المكتب، وعرض شبه كامل اعلى الجوال.
...
- `PackagesSection`: مصدر البيانات وحالة selection ولوحة HTML المتدرجة.
...
|---|---|---|
| `<720px` | مشهد 145vw بحد 560-650px، بطاقة مركزية، لوحة بعرض المحتوى اعلى المشهد | tap يطلق التسلسل، اخفاء الوصف والمزايا لضبط الارتفاع |
| `720-1199px` | مشهد 2.3:1، لوحة 390px اعلى اليسار | left-click وسحب |
