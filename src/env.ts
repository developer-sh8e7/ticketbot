...
export function loadEnv(): Env {
  return envSchema.parse({
    ...
    MEDIATOR_ROLE_ID: optionalEnv(process.env.MEDIATOR_ROLE_ID),
    LOG_CHANNEL_ID: optionalEnv(process.env.LOG_CHANNEL_ID),
    ...
    VERIFY_URL: optionalEnv(process.env.VERIFY_URL),
