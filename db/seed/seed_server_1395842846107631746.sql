...
-- شغّله بعد ترحيلات الـ schema (قابل للتشغيل من Supabase SQL editor).
-- ════════════════════════════════════════════════════════════════

insert into guilds (id, name) values ('1395842846107631746', 'Opus Store (Exempt)')
on conflict (id) do nothing;

-- إعدادات المتجر — مضمّنة مباشرة لتعمل من Supabase SQL editor.
-- المصدر: db/seed/config_1395842846107631746.json
  ...
  '{
    "bot": {
      "presence": {
        ...
        "activityName": "لطلباتكم واستفساراتكم"
      },
      "locale": "ar",
    ...
    "guild": {
      ...
      "supportRoleIds": ["1398328577312821361"],
      "managerRoleIds": ["1396566007413215242"],
      "mentionRolesOnOpen": ["1398328577312821361"]
    },
    "images": {
      "panelBannerUrl": "https://i.imgur.com/BXilqQs.png",
      "ticketBannerUrl": "https://i.imgur.com/VVXx9Dp.png",
      "thumbnailUrl": ""
    },
    "naming": {
      ...
      "zeroPadLength": 4,
      "topicTemplate": "Ticket #{ticketNumber} | User: {userTag}"
    },
    "limits": {
    ...
    "ticket": {
      "welcomeTitle": "تم فتح التذكرة بنجاح",
      "welcomeDescription": "أهلاً بك. يرجى كتابة تفاصيل طلبك أو استفسارك بوضوح، وسيقوم فريق الدعم الفني بالرد عليك في أقرب وقت ممكن.",
      "summaryTitle": "معلومات التذكرة",
      "controls": {
        "close":  { "label": "إغلاق",      "style": "Secondary", "emojiId": "1505356484471685201" },
        "add":    { "label": "إضافة",       "style": "Secondary", "emojiId": "1505357680842375319" },
        "remove": { "label": "إزالة",       "style": "Secondary", "emojiId": "1505357865072984115" },
        "claim":  { "label": "استلام",      "style": "Secondary", "emojiId": "1505361811258609705" },
        "pin":    { "label": "تثبيت",       "style": "Secondary", "emojiId": "1505361828186816592" },
        "stats":  { "label": "إحصائيات",   "style": "Secondary", "emojiId": "1505361794510622823",
                    "allowedRoleIds": ["1396566007413215242"] }
      },
      "messages": {
        "alreadyOpen":    "لديك بالفعل تذكرة مفتوحة.",
    ...
    "emojis": {
      ...
      "epicIcon": "",
      "categories": {
        "purchase":        "1505361775510556763",
        "support":         "1505361752303599645",
        "free_trial":      "1517615903678795908",
        "general_inquiry": "1505361752303599645"
      }
    },
    "categories": [
      {
        ...
        "enabled": true,
        "label": "عملية شراء",
        "description": "لشراء منتج من المتجر.",
        "channelNameTemplate": "شراء-{ticketNumber}",
        "supportRoleIds": ["1398328577312821361"],
        "questions": []
      },
      {
        ...
        "description": "لأي مشكلة تحتاج دعم فني.",
      ...
      {
        "key": "free_trial",
        "customId": "open_free_trial_ticket",
        "enabled": true,
        "label": "تجربة مجانية",
        "description": "جرب أحد منتجات Opus Solutions قبل الشراء",
        "channelNameTemplate": "trial-{ticketNumber}",
        "supportRoleIds": ["1398328577312821361"],
        "questions": []
      },
      {
        ...
        "enabled": true,
        "label": "استفسار عام",
        "description": "للاستفسارات العامة قبل الطلب.",
        "channelNameTemplate": "استفسار-{ticketNumber}",
        "supportRoleIds": ["1398328577312821361"],
        "questions": []
      }
    ],
    ...
    "roleManagement": {
      ...
      "allowedRoleIds": [
        "1483022301908832388", "1484730388898123806", "1483208475227193555",
        "1483212750074417212", "1483208671126356118", "1486862867767492890",
        "1506083939679469769", "1496651113003352188", "1505310496004378766",
        "1506346113580667111", "1504574828579913798", "1498410561287753848",
        "1505377527257104495", "1504574981953294437", "1484749681371385927"
      ],
      "blockedRoleIds": ["1506010306407694346", "1483209015961063595"],
