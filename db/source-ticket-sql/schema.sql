...
create table if not exists public.role_management_allowed_roles (
  guild_id text not null,
...
drop trigger if exists trg_role_management_allowed_roles_updated_at on public.role_management_allowed_roles;
create trigger trg_role_management_allowed_roles_updated_at
before update on public.role_management_allowed_roles
for each row
execute function public.set_role_management_updated_at();
...
alter table public.role_management_allowed_roles disable row level security;
...
grant all on table public.role_management_allowed_roles to service_role;
...
-- Include mediator warning system
-- ============================================================
